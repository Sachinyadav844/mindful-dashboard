...
const AgeDetectionCard = () => (
  <div className="p-5 rounded-xl glass-card border border-dashed border-border/80">
    <div className="flex items-center justify-between mb-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">AI-based age estimation</p>
        </div>
      </div>
      <Badge variant="secondary" className="flex items-center gap-1 bg-lavender-soft text-lavender border-lavender/30">
    ...
    <p className="text-xs text-muted-foreground mt-3 text-center">Age-based wellness recommendations will be available soon</p>
  </div>
);
