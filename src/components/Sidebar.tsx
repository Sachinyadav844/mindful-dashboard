...
import { Brain, LayoutDashboard, Activity, BookOpen, ClipboardList, User, Settings, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <aside className={cn(
      ...
      <div className="flex items-center gap-2 px-4 py-5 border-b border-white/10">
        ...
        {!collapsed && <span className="font-display font-bold text-sm">MENTALMASS</span>}
      </div>
