...
export const analyzeText = (data: { text: string }) =>
  api.post("/analyze_text", data);
export const calculateScore = (data: object) =>
  api.post("/calculate_score", data);
...
export const saveAssessment = (data: object) =>
  api.post("/save_assessment", data);
export const getJournalHistory = (filter?: string) =>
  api.get("/journal/history", { params: { filter } });
export const exportReport = () =>
  api.get("/export_report", { responseType: "blob" });
