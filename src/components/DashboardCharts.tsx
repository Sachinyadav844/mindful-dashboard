...
const trendData = [
  { day: 'Mon', score: 62 }, { day: 'Tue', score: 45 }, { day: 'Wed', score: 71 },
  { day: 'Thu', score: 38 }, { day: 'Fri', score: 55 }, { day: 'Sat', score: 78 }, { day: 'Sun', score: 68 },
];
...
export const MoodTrendChart = () => (
  <ResponsiveContainer width="100%" height={220}>
    <LineChart data={trendData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
      ...
      <YAxis domain={[0, 100]} tick={{ fontSize: 12, fill: 'hsl(230 15% 52%)' }} />
      <Tooltip contentStyle={{ borderRadius: '8px', border: '1px solid hsl(230 25% 88%)', fontSize: 12 }} />
      <Line type="monotone" dataKey="score" stroke="hsl(230 65% 55%)" strokeWidth={2.5} dot={{ r: 4, fill: 'hsl(230 65% 55%)' }} activeDot={{ r: 6 }} name="Mood Score" />
    </LineChart>
  </ResponsiveContainer>
);
...
export const EmotionPieChart = () => (
  <ResponsiveContainer width="100%" height={220}>
    <PieChart>
      <Pie data={emotionData} cx="50%" cy="50%" outerRadius={85} dataKey="value" labelLine={false} label={renderLabel}>
...
export const RiskDistributionChart = () => (
  <ResponsiveContainer width="100%" height={180}>
    <BarChart data={riskData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
      <CartesianGrid strokeDasharray="3 3" stroke="hsl(230 25% 88%)" />
      <XAxis dataKey="range" tick={{ fontSize: 11, fill: 'hsl(230 15% 52%)' }} />
